...
public class OlderCancel extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_older_cancel);
        //透明状态栏
    ...
    public void loadData(){
        ...
        String newURl = "http://121.43.234.2/postjson/JsonFromDB.aspx?TP=CDGP&URSN="+mCache.getAsString("key");
        Log.d("1234",newURl);
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                try {
                    ...
                    if (strCode == 1) {
                        ...
                        adapter = new CancelAdapter(getApplication(),(ArrayList<BuyInfo>)mList);
                        mListView.setAdapter(adapter);
